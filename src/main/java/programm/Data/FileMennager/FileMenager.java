package programm.Data.FileMennager;
...
public class FileMenager {
     ...
     * @param saveFileName - путь к файлу, в который сохраняются элементы коллекции
     */
    public FileMenager(String saveFileName) {
    ...
    public Response save(FileRequest req) {
        ...
        try (PrintWriter writer = new PrintWriter("Data/save.xml")) {
